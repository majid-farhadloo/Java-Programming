public class TestMergeSort {
	public static void main(String args[]) {
		...
		for (int j = 10000; j < 100000000; j*=10) {
			...
			/*int difference1 =MergeSort.getTime(array1);
			int difference2 = MergeSort.getTime(array2);
			int difference3 = MergeSort.getTime(array3);*/
			int difference1 =QuickSortV2.getTime(array1);
			int difference2 = QuickSortV2.getTime(array2);
			int difference3 = QuickSortV2.getTime(array3);
			sum2+=difference2;
			sum3+=difference3;
			sum1+=difference1;
